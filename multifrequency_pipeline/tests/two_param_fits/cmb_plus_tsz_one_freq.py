...
## CMB and tSZ at a single frequency. The parameters are Acmb and Atsz. ##
...
import argparse
from lfi_posteriors_one_freq import get_posterior
from likelihood_posteriors_one_freq import get_all_acmb_atsz
