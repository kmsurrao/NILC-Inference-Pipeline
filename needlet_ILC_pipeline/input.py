...
class Info(object):
    def __init__(self, input_file):
        ...
        if not self.use_Gaussian_tSZ and not self.use_lfi:
            warnings.warn(
            'You are using a Gaussian likelihood with a non-Gaussian tSZ component. For more accurate posteriors, switch use_lfi to True to use likelihood-free inference.')
